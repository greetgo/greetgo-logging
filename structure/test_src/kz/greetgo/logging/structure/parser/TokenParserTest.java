...
import kz.greetgo.logging.structure.parser_resources.ParserRes;
...
public class TokenParserTest {
  ...
  public void analyze__ok() {
...

    {
      ...
      Assertions.assertThat(assignment.category.name).isEqualTo("BO_TRACE");
      Assertions.assertThat(assignment.category.level).isEqualTo(Level.TRACE);
      Assertions.assertThat(assignment.destination.to.name).isEqualTo("to_big_file");
      Assertions.assertThat(assignment.destination.to).isInstanceOf(DestinationToRollingFile.class);
      ...
      Assertions.assertThat(assignment.destination.name).isEqualTo("boTraces");
      Assertions.assertThat(assignment.destination.level).isEqualTo(Level.TRACE);
      Assertions.assertThat(assignment.destination.fileNameWithSubPath).isEqualTo("traces/bo");
    }
    {
      var assignment = list.find("kz.greetgo.test.super", "wow");
      Assertions.assertThat(assignment.category.name).isEqualTo("kz.greetgo.test.super");
      Assertions.assertThat(assignment.category.level).isEqualTo(Level.ERROR);
      Assertions.assertThat(assignment.destination.to.name).isEqualTo("to_file");
      Assertions.assertThat(assignment.destination.to).isInstanceOf(DestinationToRollingFile.class);
      assertThat(((DestinationToRollingFile) assignment.destination.to).maxFileSizeInBytes)
      ...
      Assertions.assertThat(assignment.destination.name).isEqualTo("wow");
      Assertions.assertThat(assignment.destination.level).isEqualTo(Level.ERROR);
      Assertions.assertThat(assignment.destination.fileNameWithSubPath).isEqualTo("wow-log");
    }
    {
      var assignment = list.find("kz.greetgo.test.super", "CONSOLE");
      Assertions.assertThat(assignment.category.name).isEqualTo("kz.greetgo.test.super");
      Assertions.assertThat(assignment.category.level).isEqualTo(Level.ERROR);
      Assertions.assertThat(assignment.destination.to.name).isEqualTo("to_stdout");
      Assertions.assertThat(assignment.destination.to).isInstanceOf(DestinationToStdout.class);
      Assertions.assertThat(assignment.destination.name).isEqualTo("CONSOLE");
      Assertions.assertThat(assignment.destination.level).isEqualTo(Level.DEBUG);
    }
  ...
  public void analyze__ok__defaultLayout() {
    ...
    Assertions.assertThat(result.routing.layoutList).hasSize(1);
    Assertions.assertThat(result.routing.layoutList.get(0).name).isEqualTo(Instr.DEFAULT);
    Assertions.assertThat(result.routing.layoutList.get(0).pattern.str()).isEqualTo("Hello World");
    Assertions.assertThat(result.routing.layoutList.get(0).coloredPattern.str()).isEqualTo("Hello Colored World");
  }
  ...
  public void analyze__ok__namedLayout() {
    ...
    assertThat(result.errorList).isEmpty();
    Assertions.assertThat(result.routing.layoutList).hasSize(1);
    Assertions.assertThat(result.routing.layoutList.get(0).name).isEqualTo("testLayout");
    Assertions.assertThat(result.routing.layoutList.get(0).pattern.str()).isEqualTo("Hello World");
    Assertions.assertThat(result.routing.layoutList.get(0).coloredPattern.str()).isEqualTo("Hello Colored World");
    Assertions.assertThat(result.routing.destinationList).hasSize(1);
    Assertions.assertThat(result.routing.destinationList.get(0).layout).isNotNull();
    Assertions.assertThat(result.routing.destinationList.get(0).layout.name).isEqualTo("testLayout");
  }
  ...
  public void analyze__ok__namedLayout2() {
    ...
    Assertions.assertThat(result.routing.destinationList).hasSize(1);
    Assertions.assertThat(result.routing.destinationList.get(0).layout).isNotNull();
    Assertions.assertThat(result.routing.destinationList.get(0).layout.name).isEqualTo("testLayout2");
    Assertions.assertThat(result.routing.destinationList.get(0).layout.pattern.str()).isEqualTo("Hello World");
    Assertions.assertThat(result.routing.destinationList.get(0).layout.coloredPattern.str()).isEqualTo("Hello Colored World");
  }
  ...
  Object[][] analyze__ok__duplicatedLayoutName_DP() {
    return new Object[][]{
      ...
      {"test-config-09-err_duplicatedLayoutDefaultName.txt", Instr.DEFAULT},
    };
  }
